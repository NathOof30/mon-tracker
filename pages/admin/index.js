      ...
      {pixels.map(p => (
        <div key={p.id} className="box" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 10, flexDirection: 'column' }}>
            ...
            <button onClick={() => copyToClipboard(`${host.includes('localhost') ? 'http' : 'https'}://${host}/api/tracker/${p.id}.png`)} style={{ fontSize: '0.8em', padding: '5px 10px' }}>Copier URL Pixel</button>
